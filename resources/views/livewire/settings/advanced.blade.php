                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_registration_enabled"
                            helper="Allow new users to self-register only through enabled OAuth providers when standard registration is disabled."
                            label="OAuth Registration Allowed" />
                    </div>
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_password_login_disabled"
                            helper="Prevent OAuth-created users from setting or using local passwords. Access remains available through OAuth providers only."
                            label="Enforce OAuth-only Authentication for OAuth Users" />
                    </div>
                    <div class="md:w-96">
